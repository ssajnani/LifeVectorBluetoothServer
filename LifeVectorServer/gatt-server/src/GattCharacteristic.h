...
struct GattCharacteristic : GattInterface
{
	...
	typedef bool (*UpdatedValueCallback)(const GattCharacteristic &self, GDBusConnection *pConnection, void *pUserData, string id);
	...
	//      })
	bool callOnUpdatedValue(GDBusConnection *pConnection, void *pUserData, string id = "") const;
